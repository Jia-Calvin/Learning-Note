...
#define STATS_SERVER_CODEC(ACTION)                                                                                  \
    ...
    ACTION( swallows,               STATS_COUNTER,      "total swallow msgs")                                       \
    ACTION( sync_requests,          STATS_COUNTER,      "total sync_cache_del requests")                            \
    ACTION( sync_responses,         STATS_COUNTER,      "total sync_cache_del responses")                           \
    ACTION( cluster_requests,       STATS_COUNTER,      "total redis cluster requests")                             \
    ACTION( asking_requests,        STATS_COUNTER,      "total asking requests")                                    \
    ACTION( readonly_requests,      STATS_COUNTER,      "total readonly for redis cluster slave requests")          \
    ACTION( move_responses,         STATS_COUNTER,      "total move responses")                                     \
    ACTION( ask_responses,          STATS_COUNTER,      "total ask responses")                                      \
    ACTION( redirect_limit,         STATS_COUNTER,      "total redirect limit for redis cluster")                   \
    ACTION( mig_retry_response,     STATS_COUNTER,      "total migrating retry responses")                          \
    ACTION( mig_move_response,      STATS_COUNTER,      "total migrating move responses")                           \
    ACTION( sync_wbuf_requests,     STATS_COUNTER,      "total sync_write_buf requests")                            \
    ACTION( sync_wbuf_responses,    STATS_COUNTER,      "total sync_write_buf responses")
...
rstatus_t stats_rebuild(struct context *ctx);
